...
(findings that repeatedly die in adjudication revoke it). Per-lens application: `references/legacy/steps/review.md`
step 4 and `references/legacy/steps/review-deep.md`.
