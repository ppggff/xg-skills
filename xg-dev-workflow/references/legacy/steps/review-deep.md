...
Read this **together with** `references/legacy/steps/review.md`, and only when the chosen tier is
...
diff). Rationale + M6 calibration: `references/legacy/model-tiering.md` (5b's overlap stats
