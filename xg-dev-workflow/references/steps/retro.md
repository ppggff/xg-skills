...
- Lite cards' close-out **observation notes** (`notes/observations.md`: places synced per change · interruptions incl.
  the model's own stops · test mode per slice · questions per ask · doc time and lines read at go · missed commitments ·
  unauthorized changes checked against Go-2 · verification gaps · quality steps skipped and why · handoff gaps).
