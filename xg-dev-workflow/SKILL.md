...
- **M3 Omission check** — after **any** doc edit: requirement↔design↔detail↔plan↔test
  ...
  `workflow-status.py --check <project>/<card>` — the deterministic subset, checks (a)–(y)
  (024): ledger integrity · design sections · facts markers · part consistency · governance
  ...
  consistency · grill-signature closure; `--check <project>`
